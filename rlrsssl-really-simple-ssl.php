<?php
/**
 * Plugin Name: Really Simple SSL - BC Edit
 * Description: Lightweight plugin without any setup to make your site ssl proof. <strong>(BC Note: Href Lang manager plugin friendly version).</strong>
 * Version: 1.0.0
 * Text Domain: really-simple-ssl
 * Domain Path: /languages
 * Author: Rogier Lankhorst / Better Collective
...
$myUpdateChecker = new $className(
    'https://github.com/SmileyJoey/bc-really-simple-ssl/',
    __FILE__,
    'master'
);
